...
<div className='first-section'> 
    ...
    <h1 className={toggle ? "lightmode-header":"h1"}> Social Media Dashboard</h1>
     ...
     <div className='toggle-container'> <p>Dark Mode</p><div onClick={()=>{setToggle(!toggle)}} className={toggle ? 'slider lightmode-slider': "slider"}><button  className={toggle ? "togglebtn lightmode-btn":"togglebtn"}></button></div></div>
